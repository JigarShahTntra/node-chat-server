...
const collabNamespace = io.of("/collabs");
const shareNamespace = io.of("/shares");

collabNamespace.on("connection", async (socket) => {
  // persist session
...
shareNamespace.on("connection", async (socket) => {
  // persist session
  sessionStore.saveSession(socket.sessionID, {
    sessionID: socket.userID,
    username: socket.username,
